...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference("Membership.count") do
      post memberships_url, params: { membership: { charge: @membership.charge, client_id: @membership.client_id, gym_id: @membership.gym_id } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { charge: @membership.charge, client_id: @membership.client_id, gym_id: @membership.gym_id } }
